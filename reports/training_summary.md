...
WARNING: evaluation pool below expected size (1257 < 1308)
...
- [archive] score `0.710` confidence `0.49`
  ...
  meta `0.841` | pikalytics `0.964` | high_level `0.677` | reddit `0.668` | youtube `0.573` | archive `0.599` | random `0.270` | selfplay `0.293`
...
- [archive] score `0.697` confidence `0.49`
  ...
  meta `0.879` | pikalytics `0.997` | high_level `0.502` | reddit `0.709` | youtube `0.581` | archive `0.596` | random `0.269` | selfplay `0.295`
