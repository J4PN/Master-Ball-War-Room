...
- Timestamp: 2026-05-17T09:14:16+00:00
...
- Battle log: `data/battle_logs/training-20260517T091416Z.jsonl`
...
- [archive] score `0.698` confidence `0.50`
  ...
  meta `0.868` | pikalytics `0.985` | high_level `0.540` | reddit `0.702` | youtube `0.581` | archive `0.594` | random `0.269` | selfplay `0.293`
...
- [archive] score `0.693` confidence `0.50`
