...
- `youtube_variant`: 6.1%
- `archive`: 2.5%
- `archive_variant`: 31.2%
- `random`: 0.0%
- `selfplay`: 39.4%

WARNING: evaluation pool below expected size (1263 < 1314)
...
- [archive] score `0.737` confidence `0.74`
  ...
  meta `0.856` | pikalytics `0.986` | high_level `0.740` | reddit `0.693` | youtube `0.580` | archive `0.631` | random `0.277` | selfplay `0.298`
...
- [archive] score `0.701` confidence `0.49`
  ...
  meta `0.881` | pikalytics `0.997` | high_level `0.529` | reddit `0.709` | youtube `0.576` | archive `0.595` | random `0.269` | selfplay `0.293`
...
- `archivepikalyticsvariant637pikalyticschampionssnapshot`: matched `PokeaimMD` from `reddit` with similarity `0.810` (shell `1.00`, core `1.00`, archetype `0.00`)
