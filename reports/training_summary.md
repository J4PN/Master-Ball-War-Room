...
- Timestamp: 2026-05-08T08:49:33+00:00
...
- Battle log: `data/battle_logs/training-20260508T084933Z.jsonl`
...
- `archivepikalyticsvariant636pikalyticschampionssnapshot`: matched `PokeaimMD` from `reddit` with similarity `0.810` (shell `1.00`, core `1.00`, archetype `0.00`)
